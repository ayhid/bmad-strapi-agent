...
<critical>You MUST have already loaded and processed: {project-root}/.bmad/custom/modules/strapi-plugin-forge/workflows/generate-tests/workflow.yaml</critical>
<critical>This workflow is invoked by other workflows - expects plugin code as input</critical>
