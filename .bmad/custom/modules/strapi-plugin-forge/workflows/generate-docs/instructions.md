...
<critical>You MUST have already loaded and processed: {project-root}/.bmad/custom/modules/strapi-plugin-forge/workflows/generate-docs/workflow.yaml</critical>
<critical>This workflow is invoked by other workflows - expects plugin info as input</critical>
...
<action>Return documentation status to calling workflow</action>
</step>
