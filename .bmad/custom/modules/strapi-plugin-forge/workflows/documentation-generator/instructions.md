...
<critical>You MUST have already loaded and processed: {project-root}/.bmad/custom/modules/strapi-plugin-forge/workflows/documentation-generator/workflow.yaml</critical>
...
Invoke Muin (generate-docs workflow) to generate complete documentation.
