...
<critical>You MUST have already loaded and processed: {project-root}/.bmad/custom/modules/strapi-plugin-forge/workflows/plugin-audit/workflow.yaml</critical>
...
Invoke Basir (review-plugin workflow) to perform deep analysis.

Pass to Basir:
- Plugin path: {{plugin_path}}
- Plugin metadata: {{plugin_metadata}}
- Code quality level: {code_quality_level}
- Strapi version target: {strapi_version}
