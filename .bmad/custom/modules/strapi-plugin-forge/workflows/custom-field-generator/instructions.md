...
<critical>You MUST have already loaded and processed: {project-root}/.bmad/custom/modules/strapi-plugin-forge/workflows/custom-field-generator/workflow.yaml</critical>
...
Invoke Jamil (generate-ui workflow) to generate the custom field component.
