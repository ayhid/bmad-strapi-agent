---
name: strapi-forge-plugin-audit
description: 'Analyze an existing Strapi plugin, generate an audit report, identify improvements, and optionally apply automated fixes. Use when the user says "audit my plugin" or "review and optimize this plugin".'
---

# Plugin Audit and Optimization

**Goal:** Perform a comprehensive audit of an existing Strapi v5 plugin — code quality, security, performance, architecture, tests, documentation, and dependencies — produce a scored audit report with a prioritized improvement roadmap, and optionally apply automated fixes.
