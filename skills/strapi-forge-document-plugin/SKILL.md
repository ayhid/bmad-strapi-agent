---
name: strapi-forge-document-plugin
description: 'Generate comprehensive plugin documentation from code — README, API docs, usage guides, and configuration reference. Use when the user says "document my plugin" or "generate documentation for this plugin".'
---

# Documentation Generator

**Goal:** Analyze an existing Strapi v5 plugin's code — API endpoints, content-types, custom fields, admin UI, and configuration options — and auto-generate complete documentation: README, API reference, configuration guide, contributing guide, and changelog.
