---
name: strapi-forge-quick-scaffold
description: 'Fast Strapi v5 plugin scaffolding for experienced developers - minimal questions, basic plugin structure, ready for manual development. Use when the user says "quick scaffold a plugin" or "scaffold a Strapi plugin fast".'
---

# Quick Scaffold

**Goal:** Scaffold a basic Strapi v5 plugin structure in minutes — collect minimal metadata (name, type, description), generate the standard folder layout with registration files, package.json, README, and .gitignore, ready for manual development.
