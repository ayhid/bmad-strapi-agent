---
name: strapi-forge-generate-docs
description: 'Generate comprehensive plugin documentation - README, API docs, guides, examples from code and architecture. Use when the user says "generate docs for the plugin".'
---

# Generate Docs

**Goal:** Generate complete, developer-friendly documentation for a Strapi v5 plugin from its code and architecture — README, API reference, data model docs, configuration guide, usage examples, troubleshooting guide, contributing guide, and changelog.
