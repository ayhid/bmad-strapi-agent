---
name: strapi-forge-review-plugin
description: 'Comprehensive code review - quality, security, performance, best practices validation. Use when the user says "review the plugin" or "run a code review on my Strapi plugin".'
---

# Review Plugin

**Goal:** Perform a comprehensive review of a Strapi v5 plugin — best practices compliance, security vulnerability scan, performance analysis, code quality, Design System compliance, and test coverage — producing category scores and a full review report.
