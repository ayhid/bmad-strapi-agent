---
name: strapi-forge-generate-tests
description: 'Generate comprehensive test suite - unit tests, integration tests, component tests with fixtures and mocks. Use when the user says "generate tests for the plugin".'
---

# Generate Tests

**Goal:** Generate a comprehensive test suite for a Strapi v5 plugin — unit tests for services and controllers, integration tests for API endpoints, component tests for the admin UI, plus fixtures, mocks, helpers, and Jest configuration.
