---
name: strapi-forge-create-plugin
description: 'Create complete Strapi v5 plugin from concept to functional prototype - orchestrates architecture, backend, frontend, tests, code review, and documentation. Use when the user says "create a new Strapi plugin" or "build a complete plugin".'
---

# New Plugin Creation

**Goal:** Guide the user from plugin concept to a production-ready Strapi v5 plugin — collaborative discovery and architecture planning, then orchestrated generation of backend code, admin UI, tests, code review, and documentation, assembled into a ready-to-install plugin.
...
On completion, validate the result against `checklist.md` and report any gaps.
