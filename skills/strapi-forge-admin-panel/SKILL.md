---
name: strapi-forge-admin-panel
description: 'Design custom admin interfaces with routing, navigation, and layout using the Strapi Design System. Use when the user says "design an admin panel" or "build an admin interface for my plugin".'
---

# Admin Panel Designer

**Goal:** Design and generate a complete custom admin panel for a Strapi v5 plugin — requirements, navigation and routing, page layouts built on the Strapi Design System, data fetching and state management, reusable components, API integration, tests, and documentation.
