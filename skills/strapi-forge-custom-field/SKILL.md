---
name: strapi-forge-custom-field
description: 'Create custom field types for the Strapi content editor with validation and Design System integration. Use when the user says "create a custom field" or "build a custom field type for Strapi".'
---

# Custom Field Generator

**Goal:** Guide the user from custom field specification through UI design to a complete, tested Strapi v5 custom field plugin — server-side registration, React component built on the Strapi Design System, client and server validation, tests, and documentation.
